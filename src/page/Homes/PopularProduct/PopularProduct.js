...
const PopularProduct = () => {
    return (
        <div className=' mt-10 mb-5'>
            <div className='px-12 lg:flex justify-between justify-items-center'>
                <h2 className='text-4xl font-quesha'>Our Popular Products</h2>
                <button class="btn btn-outline hover:bg-secondary text-white normal-case w-32 p-0 my-5 lg:mt-0">See All</button>
            </div>
            <div className="card shadow-xxl">
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-items-center lg:p-10 gap-5 '>
                    {
                        productData.map(item => (<div className='p-5 lg:p-10 grid justify-items-center w-80 lg:w-96 mx-auto leading-10 rounded-lg' style={{ backgroundColor: '#0E0E0E' }} key={item.id}>
